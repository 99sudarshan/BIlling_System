...
import { fetchAllReprts } from "../../../api/services/system/systemUserApiService";
import CSV from "../../../common/CSV";
import { options } from "../../../common/dateOptions";
import Excell from "../../../common/Excell";
import MainHeader from "../../../common/MainHeader";
import Pagination from "../../../common/Pagination";
import AllReportPdfConverter from "./AllReportPdfConverter";
...
const AllReports = () => {
  ...
  useEffect(() => {
    fetchAllReprts(type, setAllReports);
    //eslint-disable-next-line
  }, [type]);
    ...
    <div>
      ...
      <div className="flex justify-between items-center mt-3">
        <div className="flex gap-3 items-center">
          <CSV file={`all-reports`} data={allReports} />
          <Excell file={`all-reports`} data={allReports} />
          <AllReportPdfConverter report_list={allReports} />
              ...
              {allReports.length > 0 ? (
                <>
                  {currentActivityLists
                    ...
                    .map((data, index) => {
                      const { ordered_date, total_amount } = data;
                      return (
                        <tr
                        ...
                        >
                          ...
                          <td className="px-4 py-3 text-xs">{total_amount}</td>
                        </tr>
                      );
                    })}
                </>
