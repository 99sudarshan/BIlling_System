...
import { fetchAuditTrailReport } from "../../../api/services/system/systemUserApiService";
...
const AuditTrailReport = () => {
  ...
  useEffect(() => {
    fetchAuditTrailReport(setAllReports, setCompanyInfo);
    //eslint-disable-next-line
  }, []);
  ...
  return (
    <>
      ...
      <CommonPopup
        width="max-w-md"
        open={editReport}
        closeModal={() => setEditReport(false)}
      >
        <EditReport />
      </CommonPopup>
      <div>
        <MainHeader text="Audit Trail Reports" />
        <div className="flex justify-between items-center mt-3">
          <div className="flex gap-3 items-center">
            <CSV file={`audit-trail-report`} data={allReports} />
            <Excell file={`audit-trail-report`} data={allReports} />
